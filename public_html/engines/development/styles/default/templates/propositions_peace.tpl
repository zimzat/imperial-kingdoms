...
{include file="status.tpl"}
		...
		<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
			<tr>
				<th width="100%" valign="middle" align="center" height="25" class="thCornerL" nowrap="nowrap">Proposition: Peace Declaration</th>
			</tr>
			<tr>
				<td valign="middle" align="justify" class="row1" width="100%">Enter the ID of the kingdom you would like to propose a peace treaty with.</td>
			</tr>
			<tr>
				<td valign="middle" align="center" class="row1" width="100%">
					<form method="post" action="{$actionurl}" name="propositions" id="propositions">
					<input name="fn" type="hidden" value="propositions_peace" />
					<input name="action" type="hidden" value="details_submit" />
					
					Declare peace with: (Kingdom ID):<br />
					<input type="text" name="target_kingdom_id" class="post" /><br />
					<br />
					
					Make a statement to convince your kingdom and the other kingdom to vote for your proposal. Should it pass it will also be in the news.<br />
