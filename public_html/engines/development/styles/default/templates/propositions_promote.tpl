...
{include file="status.tpl"}
		...
		<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline">
			<tr>
				<th width="100%" valign="middle" align="center" height="25" class="thCornerL" nowrap="nowrap">Proposition: Promote Prisoner</th>
			</tr>
			<tr>
				<td valign="middle" align="justify" class="row1" width="100%">Select the player you would like promoted from the list below.</td>
			</tr>
			<tr>
				<td valign="middle" align="center" class="row1" width="100%">
					<form method="post" action="{$actionurl}" name="propositions" id="propositions">
					<input name="fn" type="hidden" value="propositions_promote" />
					<input name="action" type="hidden" value="details_submit" />
					
					Member to promote:<br />
