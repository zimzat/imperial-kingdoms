...
{literal}
		...
		<!--
			...
			//if (getCookie('varMirrorPanes')) fnMirrorPanes();
		// -->
		</script>
{/literal}
		...
		<!-- Info Pane -->
		<div id="pane_info" class="forumline" style="left: 15px; width: 180px;">
		...
		<!-- Cluster Pane -->
		<div id="pane_cluster" class="forumline" style="left: 28px; width: 105px;">
		...
		<!-- Quadrant Pane -->
		<div id="pane_quadrant" class="forumline" style="left: 175px; width: 105px;">
		...
		<!-- StarSystem Pane -->
		<div id="pane_starsystem" class="forumline" style="left: 292px; width: 105px;">
