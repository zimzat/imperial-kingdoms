...
function fnEnlarge()
{
	var varDivs = new Array('pane_info', 'paneI_graphic', 'paneI_nextplanet', 'paneI_nextplanet2', 'paneI_backplanet', 'paneI_backplanet2', 'paneI_empire');
	
	for (x in varDivs)
	{
		xTop(varDivs[x], (xGetComputedStyle(xGetElementById(varDivs[x]), 'top', true) + 285));
	}
	
	xVisibility('paneI_up', true);
	xVisibility('paneI_down', false);
}
function fnShrink()
{
	var varDivs = new Array('pane_info', 'paneI_graphic', 'paneI_nextplanet', 'paneI_nextplanet2', 'paneI_backplanet', 'paneI_backplanet2', 'paneI_empire');
	...
	xVisibility('paneI_up', false);
	xVisibility('paneI_down', true);
}
//var varMirrorPanes = false;
function fnMirrorPanes()
{
	var varDivs = new Array(
		'pane_info', 'paneI_graphic', 'paneI_down', 'paneI_up', 'paneI_nextplanet', 'paneI_nextplanet2', 'paneI_backplanet', 'paneI_backplanet2', 'paneI_empire',
